...
import static com.smithster.gr8plugin.Plugin.Spawns;
...
public class createSpawn implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command, String label, String[] args) {
        ...
        Integer[] loc = { player.getLocation().getBlockX(), player.getLocation().getBlockY(),
                player.getLocation().getBlockZ() };

        if (Spawns.find(eq("name", args[0])).first() == null) {
